...
public partial class HomePage : ContentPage
{
    ...
    class Drawable : IDrawable
	{
		public void Draw(ICanvas canvas, RectF dirtyRect)
		{
            ...
            // View:     frameView
            // NodeName: Strona Lista uczestników widok uczestnika
            // NodeType: FRAME
            // NodeId:   1:14
            canvas.SaveState();
            ...
            // View:     textView
            // NodeName: Eksportuj listê do PDF
            // NodeType: TEXT
            // NodeId:   1:20
            canvas.SaveState();
            ...
            canvas.FontSize = 14f;
            canvas.DrawString(@"Eksportuj listê do PDF", 195f, 812f, 150f, 17f, HorizontalAlignment.Center, VerticalAlignment.Center);
            canvas.RestoreState();
